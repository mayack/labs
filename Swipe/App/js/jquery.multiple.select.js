...
//a2
var d=$el.parent().find('.sel_mod').prop('id');

//console.log($el.parent().find('.sel_mod').prop('id'));

//console.log($el.parent().find('.select-single').prop('id'));
        $el.parent().hide();
        ...
        this.$parent = $('<div' + ' id="m_'+d+'" ' + $.map(['class', 'title'],function (att) {
